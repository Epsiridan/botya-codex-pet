...
1. Откройте [`INSTALL_PROMPT.md`](INSTALL_PROMPT.md).
2. Скопируйте промпт целиком и отправьте его своему агенту Codex.
3. После установки полностью завершите Codex и запустите приложение снова.
...
Это публичная тестовая версия для установки и проверки в Codex. Авторские права на персонажа и визуальные материалы сохраняются за правообладателем; см. [`NOTICE.md`](NOTICE.md).
